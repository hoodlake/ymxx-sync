...
insert into bt_param
       ...
       REVERSE9,
       REVERSE10) values (
       'isInterBankAllot','nis','是否跨行调拨','0',null,null,0,'是否跨行调拨 0,否;1,是','0,否;1,是',null,null,null,null,1,null,null,null,null);

--新增字段“保底金额”
alter table bt_bank_acc add MIN_BALANCE  NUMBER(14,2);

CREATE OR REPLACE VIEW V_NEW_BANK_ACC_INFO AS
