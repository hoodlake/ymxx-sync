...
--参数设置： 
ALTER TABLE CMS_LOAN_BILL ADD CLB_BIIL_FIX NUMBER(15,2);
ALTER TABLE CMS_LOAN_BILL ADD CLB_BILL_AGREEMENT NUMBER(15,2);
ALTER TABLE CMS_LOAN_BILL ADD CLB_PAY_FIX NUMBER(15,2);
ALTER TABLE CMS_LOAN_BILL ADD CLB_PAY_AGREEMENT NUMBER(15,2);
ALTER TABLE CMS_LOAN_BILL ADD CLB_ABATE_FIX NUMBER(15,2);
ALTER TABLE CMS_LOAN_BILL ADD CLB_ABATE_AGREEMENT NUMBER(15,2);
ALTER TABLE CMS_LOAN_BILL ADD CLB_UNPAY_FIX NUMBER(15,2);
ALTER TABLE CMS_LOAN_BILL ADD CLB_UNPAY_AGREEMENT NUMBER(15,2);
