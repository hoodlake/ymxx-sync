...
comment on column CMS_LOAN_INFO.LOAN_GENRE is '贷款类型，1：流动资金贷款     2：票据借贷';
commit;
...
comment on column AB_RECEIVE.LOAN_REPAY_BILL_CODE is '贷款还款表中的主键';
commit;
--修改时间2012-9-11
--修改人 李德成
--修改内容 还款表 
ALTER TABLE CMS_LOAN_REPAY ADD(PAY_TYPE  varchar2(1)); 
comment on column CMS_LOAN_REPAY.PAY_TYPE is '支付方式   1:现汇支付   2:票据支付';
commit;