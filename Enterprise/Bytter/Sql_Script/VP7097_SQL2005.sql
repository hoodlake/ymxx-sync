...
BEGIN
  SELECT @VN_COUNT = COUNT(*)
    FROM BT_SYS_RES
  WHERE SYS_CODE = 'fqs' and res_name='银行融资明细报表' and res_level = '2';
  IF @VN_COUNT < 1
    BEGIN
  ...
  SELECT @VN_COUNT = COUNT(*)
    FROM BT_SYS_RES
  WHERE SYS_CODE = 'fqs' and res_name='经营性融资发生额统计表' and res_level = '2';
  IF @VN_COUNT < 1
    BEGIN
      	insert into bt_sys_res (RES_CODE,RES_NAME,SYS_CODE,FATHER_CODE,RES_URL,FUNC_FLAG,RES_TYPE,LINK_TARGET,STATUS,RES_ORDER,RMK,REVERSE1,REVERSE2,REVERSE3,REVERSE4,REVERSE5,REVERSE6,REVERSE7,REVERSE8,REVERSE9,REVERSE10,RES_LEVEL) 
  ...
  SELECT @VN_COUNT = COUNT(*)
    FROM BT_SYS_RES
  WHERE SYS_CODE = 'fqs' and res_name='融资结构分析报表' and res_level = '2';
  IF @VN_COUNT < 1
    BEGIN
      	insert into bt_sys_res (RES_CODE,RES_NAME,SYS_CODE,FATHER_CODE,RES_URL,FUNC_FLAG,RES_TYPE,LINK_TARGET,STATUS,RES_ORDER,RMK,REVERSE1,REVERSE2,REVERSE3,REVERSE4,REVERSE5,REVERSE6,REVERSE7,REVERSE8,REVERSE9,REVERSE10,RES_LEVEL) 
