CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_BACK
AS
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_BKED
AS
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_BKQY
AS
   SELECT E.VOUCHER_NO, E.CORP_ID, T.CORP_NAME, E.BIF_CODE,
          B.NAME AS BIF_NAME, E.ACCTID, E.PRODNO, P.PRODNAME, P.TARGET,
          (CASE
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_INFO
AS
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_MODY
AS
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_MONY
AS
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_QUEY
AS
   SELECT E.VOUCHER_NO, P.PRODNO, P.PRODNAME, P.CURRENCY, C.CUR_NAME,
          P.TARGET,
          (CASE
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_QYHI
AS
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_PRODUCT_SIGN
AS
...
CREATE OR REPLACE FORCE VIEW V_BIS_FIN_STATES_QUERY
AS
