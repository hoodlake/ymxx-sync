...
select (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '理财产品销售', 'cho', 0, '', '0', '1', '0', '0', 7, '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, 1
go
...
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '理财产品同步查询', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=synBisFinProduct'+char(38)+'NUMERICmethodTargetNUMERIC=Sign', '0', '0', '0', '0', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品购买'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '理财产品购买申请', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=synBisFinProduct'+char(38)+'NUMERICmethodTargetNUMERIC=Purchase', '0', '0', '0', '0', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品购买'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '理财产品购买申请修改', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=synBisFinProduct'+char(38)+'NUMERICmethodTargetNUMERIC=Modify', '0', '0', '0', '0', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品购买'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '理财产品购买结果查询', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=synBisFinProduct'+char(38)+'NUMERICmethodTargetNUMERIC=Query', '0', '0', '0', '0', 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品购买'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
...
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '赎回申请', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=bisFinBack'+char(38)+'NUMERICmethodTargetNUMERIC=Back', '0', '0', '0', '0', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品赎回'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '赎回申请修改', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=bisFinBack'+char(38)+'NUMERICmethodTargetNUMERIC=Modify', '0', '0', '0', '0', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品赎回'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '赎回申请结果查询', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=bisFinBack'+char(38)+'NUMERICmethodTargetNUMERIC=Query', '0', '0', '0', '0', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品赎回'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
...
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '理财产品签约状态查询', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=synBisFinProduct'+char(38)+'NUMERICmethodTargetNUMERIC=State', '0', '0', '0', '0', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品查询'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '理财资产余额查询', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=queryMoneyProduct'+char(38)+'NUMERICmethodTargetNUMERIC=Money', '0', '0', '0', '0', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品查询'
go
INSERT INTO BT_SYS_RES (RES_CODE, RES_NAME, SYS_CODE, FATHER_CODE, RES_URL, FUNC_FLAG, RES_TYPE, LINK_TARGET, STATUS, RES_ORDER, RMK, REVERSE1, REVERSE2, REVERSE3, REVERSE4, REVERSE5, REVERSE6, REVERSE7, REVERSE8, REVERSE9, REVERSE10, RES_LEVEL, RES_ROLE)
SELECT (SELECT MAX(RES_CODE) + 1 FROM BT_SYS_RES), '理财资产交易明细查询', 'cho', RES_CODE, '/chowmatistic/bisFinProduct.jsp?url=queryDetailProduct'+char(38)+'NUMERICmethodTargetNUMERIC=Query', '0', '0', '0', '0', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '' FROM BT_SYS_RES WHERE RES_NAME = '理财产品查询'
go
