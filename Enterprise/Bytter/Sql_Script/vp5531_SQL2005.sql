...
declare  @max_id_cs20121204 int,@max_id_cs20121204_id int,@max_id_cs20121204_1 int;
 begin
    select @max_id_cs20121204=count(*)  from bt_function where FUNCTION_IDEN='w_query_subject_balance_collect';
    if @max_id_cs20121204=0 
		begin
		  select @max_id_cs20121204_id=function_id  from bt_function where FUNCTION_NAME = '余额';
		  select @max_id_cs20121204_1=max(function_id)+1  from BT_FUNCTION;
		  ...
		  select @max_id_cs20121204=FUNCTION_ID   from bt_function where FUNCTION_IDEN='w_query_subject_balance_collect';
		  ...
		  select @max_id_cs20121204_1=max(function_id)+1  from BT_FUNCTION;
		  insert into bt_function (FUNCTION_ID, FUNCTION_IDEN, FUNCTION_NAME, DISPLAY_PIC, USER_EVENT, HOTKEY, FUN_TYPE, UPPER_FUNCTION_ID, SEQ_NO, ARRANGEOPEN, TURNON_SIGN, SYS_CODE, RMK, VALID_SIGN)
		  values (@max_id_cs20121204_1, '', '查询', 'bmp\query.bmp', 'ue_query', 'Q', 'Btn', @max_id_cs20121204, 1, '', '1', 'counter', '查询记录', '1'); 
      end   
