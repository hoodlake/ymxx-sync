...
create table cms_dunningNotices (
       noticeType      varchar(12)       not null,  --催款类型
       noticeTitle     varchar(100)              ,--催款标题
       noticeContent   varchar(500)             ,--催款内容
       noticeFoot      varchar(100)             ,--催款结尾
       rmk             varchar(100)             ,--备注
...
values (18, 'cms', '18', '企业贷款/借款到期提醒', 10, '企业贷款/借款到期提醒', '您有${count}笔企业贷款/借款到期！', '', '', '2', '1', '2010-08-03', null)
go